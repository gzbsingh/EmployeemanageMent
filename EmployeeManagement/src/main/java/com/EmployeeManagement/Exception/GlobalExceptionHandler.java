...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorFormat> GetEmployeeNotFoundException(EmployeeNotFoundException ex , WebRequest request){
	...
	public ResponseEntity<ErrorFormat> GetDepartMentNotFoundException(DepartMentNotFoundException ex , WebRequest request){
		return new ResponseEntity<ErrorFormat>(new ErrorFormat(LocalDateTime.now(),ex.getMessage(),request.getDescription(false)),HttpStatus.BAD_REQUEST);
	}
